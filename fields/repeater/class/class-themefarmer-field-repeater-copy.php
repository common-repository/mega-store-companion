				...
				<div class="themefarmer-repeater-repeater">
					<?php if (!empty($value)): foreach ($value as $ikey => $item): ?>
							<div class="themefarmer-repeater-repeater-group">
								<div class="themefarmer-repeater-repeater-element">
									<div class="icon-field-group">
										<span>
											...
											<input type="text" class="widefat icon-select-field themefarmer-repeater-repeater-field" data-tf-index="icon" value="<?php echo esc_attr($item['icon']); ?>">
										</span>
										<?php
											if (file_exists($this->icon_container)) {
												include $this->icon_container;
								...
								<div class="themefarmer-repeater-repeater-element">
									<input type="text" class="widefat themefarmer-repeater-repeater-field" data-tf-index="link" value="<?php echo esc_attr($item['link']); ?>">
								</div>
								<button type="button" class="tf-remove-button themefarmer-repeater-remove-repeater"><?php esc_html_e('Remove Icon', 'mega-store-companion');?></button>
							</div>
							<?php endforeach;endif;?>
							<?php $button_label = (isset($value['button_label'])) ? $value['button_label'] : __('Add Icon', 'mega-store-companion');?>
	...
	private function get_repeater_field($field = array(), $key = '', $value = '') {
		...
		switch ($type) {
			...
			default:
				...
				<div class="themefarmer-repeater-repeater-element">
					<div class="icon-field-group">
						<span>
							...
							<input type="text" class="widefat icon-select-field themefarmer-repeater-repeater-field" data-tf-index="icon" value="">
						</span>
						<?php
							if (file_exists($this->icon_container)) {
											include $this->icon_container;
				...
				<div class="themefarmer-repeater-repeater-element">
					<input type="text" class="widefat themefarmer-repeater-repeater-field" data-tf-index="link" value="">
				</div>
				<?php
			break;
		}	
