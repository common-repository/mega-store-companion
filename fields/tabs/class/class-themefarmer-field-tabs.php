...
class ThemeFarmer_Field_Tabs extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style('themefarmer-tabs', MEGA_STORE_COMPANION_URI . 'fields/tabs/css/themefarmer-tabs.css');
		wp_enqueue_script('themefarmer-tabs', MEGA_STORE_COMPANION_URI . 'fields/tabs/js/themefarmer-tabs.js', array('jquery'), null, true);
	}
