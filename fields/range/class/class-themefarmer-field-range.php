...
class ThemeFarmer_Field_Range extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style('themefarmer-range-slider', MEGA_STORE_COMPANION_URI . 'fields/range/css/themefarmer-range.css');
		wp_enqueue_script('themefarmer-range-slider', MEGA_STORE_COMPANION_URI . 'fields/range/js/themefarmer-range.js', array('jquery'), null, true);
	}
	...
	protected function render_content() {
		...
		if(is_string($data) && is_array(json_decode($data, true))){
			...
			$values['desktop']  = $json['desktop'];
			$values['mobile']  = $json['mobile'];
			$values['tablet']  = $json['tablet'];
		}else{
			$values['desktop']  = $data;
			$values['mobile']  	= $data;
			$values['tablet']  	= $data;
		...
		?>
		<div class="themefarmer-range-slider-container">
			...
			<span class="themefarmer-device-controls">
				<button type="button" class="preview-desktop active" data-device="desktop" title="<?php esc_attr_e('Click to set font for desktop devices', 'mega-store'); ?>">
					<i class="dashicons dashicons-desktop"></i>
				</button>
				<button type="button" class="preview-tablet" data-device="tablet" title="<?php esc_attr_e('Click to set font for tablet devices', 'mega-store'); ?>">
					<i class="dashicons dashicons-tablet"></i>
				</button>
				<button type="button" class="preview-mobile" data-device="mobile" title="<?php esc_attr_e('Click to set font for mobile devices', 'mega-store'); ?>">
			...
			<div class="themefarmer-range-slider-controls-con">
				...
				<div class="themefarmer-range-slider-controls range-slider-desktop active">
					...
					<input class="themefarmer-range-value" data-device="desktop" type="text" id="themefarmer-range-value-desktop-<?php echo esc_attr($this->id); ?>" value="<?php echo esc_attr($values['desktop']); ?>">
				...
				<div class="themefarmer-range-slider-controls range-slider-tablet">
					...
					<input class="themefarmer-range-value" data-device="tablet" type="text" id="themefarmer-range-value-tablet-<?php echo esc_attr($this->id); ?>" value="<?php echo esc_attr($values['tablet']); ?>">
					<span class="range-slider-reset" data-value="<?php echo esc_attr(absint($default)); ?>">
						<i class="dashicons dashicons-image-rotate"></i>
					</span>
				</div>	
				<div class="themefarmer-range-slider-controls range-slider-mobile">
					...
					<input class="themefarmer-range-value" data-device="mobile" type="text" id="themefarmer-range-value-mobile-<?php echo esc_attr($this->id); ?>" value="<?php echo esc_attr($values['mobile']); ?>">
					<span class="range-slider-reset" data-value="<?php echo esc_attr(absint($default)); ?>">
						<i class="dashicons dashicons-image-rotate"></i>
					</span>
				</div>
				...
				<div class="themefarmer-range-slider-controls range-slider-desktop active">
					...
					<input class="themefarmer-range-value" type="text" id="themefarmer-range-value-<?php echo esc_attr($this->id); ?>" value="<?php echo esc_attr($values['desktop']); ?>">
					<span class="range-slider-reset" data-value="<?php echo esc_attr(absint($default)); ?>">
						<i class="dashicons dashicons-image-rotate"></i>
					</span>
				</div>
